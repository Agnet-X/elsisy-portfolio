      ...
      <div className="container mx-auto px-6 md:px-12">
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden rounded-lg bg-[#0a0a0a]">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black via-black/80 to-transparent z-20">
                    <p className="text-primary text-[10px] uppercase tracking-widest mb-2 opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                      {item.category}
                    </p>
                    <h3 className="text-xl text-white font-serif opacity-90 group-hover:opacity-100 transition-opacity">
                      {item.title}
                    </h3>
                  </div>
                </div>
        ...
        {filteredPortfolio.length === 0 && (
          <div className="text-center py-32 border border-dashed border-white/10 rounded-xl">
            <p className="text-white/50 font-serif text-xl">{t.empty}</p>
          </div>
        )}
      </div>
    </div>
